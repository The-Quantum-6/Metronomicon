    ...
    <div className="min-h-screen bg-surface-dark text-text">
      ...
      <main className="container mx-auto max-w-4xl p-6">
        ...
        <section className="mb-12">
          ...
          <div className="flex items-center gap-4 bg-bg border border-border rounded-lg px-5 py-4">
        ...
        <section>
          ...
          <div className="flex items-start gap-4 bg-bg border border-border rounded-lg px-5 py-4">
            <ExclamationmarkTriangleFillIcon
              aria-hidden
